...
public class RemoteUnityScene : MonoBehaviour
{
    ...
    uint MSG_CreateInteractableText(byte[] data)
    {
        ...
        go.GetComponent<TextMeshPro>().enableWordWrapping = false;
        go.GetComponent<TextMeshPro>().autoSizeTextContainer = true;
        go.GetComponent<TextMeshPro>().alignment = TextAlignmentOptions.Center;
